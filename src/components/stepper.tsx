...
import { FileUp, Eye, FileJson, Link as LinkIcon, CheckCircle2, ChevronRight, Send, Check, User, Component } from "lucide-react"
...
const steps = [
  ...
  { name: "Rest Flow", href: "/new/rest-flow", icon: Component },
